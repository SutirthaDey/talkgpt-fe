...
const LandingPage = () => {
  return (
    <div className="h-screen w-screen bg-[#FAFAFBFF] relative overflow-hidden">
      <div className="h-[450px] w-[550px] bg-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-2 border-red-400 rounded-xl text-center z-20">
        <img
        ...
        <div className="h-30 w-full flex flex-col px-36 justify-center gap-3 mt-10">
          <button className="h-[52px] w-30 bg-[#171A1FFF] text-white rounded-md font-[400px] font-inter leading-7 text-lg hover:bg-[#272c35]">
            Sign up
          </button>
          <button className="h-[52px] w-30 mx-10  text-[#171A1FFF] font-[400px] font-inter leading-7 text-lg hover:bg-[#ececec]">
            Sign in
          </button>
        </div>
      </div>
      ...
      <svg
        ...
        stroke-width="1.5"
        viewBox="0 0 16 16"
        className="absolute top-[675px] left-[1510px]"
      >
